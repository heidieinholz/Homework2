...
# Getting Started:
 Using the files here, you should be able to access Heidi Einholz's Responsive Portfolio, an updated version of Homework #1 using Bootstrap to allow for scaling.
...
Author: Heidi Einholz, October 2019
